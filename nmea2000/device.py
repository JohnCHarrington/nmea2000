...
class N2KDevice:
    ...
    def _name_value_from_message(self, message: NMEA2000Message) -> int:
        payload = self.client.encoder._call_encode_function(message)
    ...
    def _build_heartbeat_message(self) -> NMEA2000Message:
        ...
        return NMEA2000Message(
            ...
            priority=6,
            fields=[
                NMEA2000Field("dataTransmitOffset", value=60, raw_value=60),
    ...
    def _build_product_information_message(self) -> NMEA2000Message:
        return NMEA2000Message(
            ...
            priority=6,
            fields=[
                NMEA2000Field("nmea2000Version", value=self.nmea2000_version, raw_value=self.nmea2000_version),
