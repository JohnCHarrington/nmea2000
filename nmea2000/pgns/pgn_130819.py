...
def decode_pgn_130819(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130819_simnetRequestReprogram(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130819_maretronAlertTransmission(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130819_simnetRequestReprogram(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130819."""
...
def decode_pgn_130819_maretronAlertTransmission(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130819."""
