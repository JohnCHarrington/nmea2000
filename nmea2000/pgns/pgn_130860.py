...
def is_fast_pgn_130860() -> bool:
    ...
    return True
def decode_pgn_130860(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130860."""
    ...
    d = d_raw = decode_number(_data_raw_, running_bit_offset, 32, False, 1, 0, 4294967292)
    ...
    f = f_raw = decode_number(_data_raw_, running_bit_offset, 32, False, 1, 0, 4294967292)
