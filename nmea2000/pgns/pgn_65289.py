...
def decode_pgn_65289(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_65289_simnetTrimTabSensorCalibration(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_65289_maretron010V(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_65289_simnetTrimTabSensorCalibration(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65289."""
...
def decode_pgn_65289_maretron010V(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65289."""
