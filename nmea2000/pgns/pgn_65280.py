...
def decode_pgn_65280(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_65280_furunoHeave(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_65280_maretronKeelPosition(data_raw, data_length_bits)
    
    return decode_pgn_65280_0xff000xffffManufacturerProprietarySingleFrameNonAddressed(data_raw, data_length_bits)
    
def decode_pgn_65280_0xff000xffffManufacturerProprietarySingleFrameNonAddressed(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65280."""
...
def decode_pgn_65280_furunoHeave(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65280."""
...
def decode_pgn_65280_maretronKeelPosition(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65280."""
