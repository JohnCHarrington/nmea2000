...
def decode_pgn_61184(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_61184_seatalkWirelessKeypadLightControl(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_61184_seatalkWirelessKeypadControl(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_61184_victronBatteryRegister(data_raw, data_length_bits)
    
    return decode_pgn_61184_0xef00ManufacturerProprietarySingleFrameAddressed(data_raw, data_length_bits)
    
def decode_pgn_61184_0xef00ManufacturerProprietarySingleFrameAddressed(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 61184."""
...
def decode_pgn_61184_seatalkWirelessKeypadLightControl(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 61184."""
    ...
    variant = variant_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
    ...
    wireless_setting = wireless_setting_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
    ...
    wired_setting = wired_setting_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
...
def encode_pgn_61184_seatalkWirelessKeypadLightControl(nmea2000Message: NMEA2000Message) -> bytes:
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Variant' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Variant' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Variant' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Wireless Setting' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Wireless Setting' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Wireless Setting' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Wired Setting' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Wired Setting' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Wired Setting' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
...
def decode_pgn_61184_seatalkWirelessKeypadControl(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 61184."""
    ...
    running_bit_offset = 32
    beep_control = beep_control_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
...
def encode_pgn_61184_seatalkWirelessKeypadControl(nmea2000Message: NMEA2000Message) -> bytes:
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Beep Control' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Beep Control' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Beep Control' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
...
def decode_pgn_61184_victronBatteryRegister(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 61184."""
    ...
    running_bit_offset = 16
    register_id = register_id_raw = decode_number(_data_raw_, running_bit_offset, 16, False, 1, 0, 65532)
    ...
    running_bit_offset = 32
    payload = payload_raw = decode_number(_data_raw_, running_bit_offset, 32, False, 1, 0, 4294967292)
...
def encode_pgn_61184_victronBatteryRegister(nmea2000Message: NMEA2000Message) -> bytes:
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Register Id' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Register Id' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Register Id' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
