...
def is_fast_pgn_130321() -> bool:
    ...
    return True
def decode_pgn_130321(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130321."""
    ...
    salinity = salinity_raw = decode_float(_data_raw_, running_bit_offset, 32, -3.40282346638529e+38, 3.40282346638529e+38)
...
def encode_pgn_130321(nmea2000Message: NMEA2000Message) -> bytes:
    ...
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
    payload_bit_length = max(payload_bit_length, payload_end_offset)
    # stationId | Offset: 168, Length: , Resolution: , Field Type: STRING_LAU
    running_bit_offset = 168
    field_offset = running_bit_offset
