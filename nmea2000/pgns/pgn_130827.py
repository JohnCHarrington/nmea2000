...
def is_fast_pgn_130827() -> bool:
    ...
    return True
def decode_pgn_130827(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130827."""
    ...
    e = e_raw = decode_number(_data_raw_, running_bit_offset, 16, False, 1, 0, 65532)
    ...
    f = f_raw = decode_number(_data_raw_, running_bit_offset, 16, False, 1, 0, 65532)
