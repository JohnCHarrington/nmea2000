...
def decode_pgn_130834(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130834_maretronSmsStatus(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130834_simnetEngineAndTankConfiguration(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130834_maretronSmsStatus(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130834."""
...
def decode_pgn_130834_simnetEngineAndTankConfiguration(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130834."""
