...
def decode_pgn_130838(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130838_maretronBnwas(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130838_simnetFluidLevelWarning(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130838_maretronBnwas(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130838."""
...
def decode_pgn_130838_simnetFluidLevelWarning(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130838."""
