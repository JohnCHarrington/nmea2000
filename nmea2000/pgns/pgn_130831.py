...
def decode_pgn_130831(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130831_maretronUniversalConfigurationFp(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130831_suzukiEngineAndStorageDeviceConfig(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130831_maretronUniversalConfigurationFp(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130831."""
...
def decode_pgn_130831_suzukiEngineAndStorageDeviceConfig(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130831."""
