...
def decode_pgn_65292(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_65292_simnetClearFluidLevelWarnings(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_65292_maretronAutomationFunctionMaster(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_65292_simnetClearFluidLevelWarnings(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65292."""
...
def decode_pgn_65292_maretronAutomationFunctionMaster(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65292."""
