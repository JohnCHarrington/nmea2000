...
def decode_pgn_65290(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_65290_simnetPaddleWheelSpeedConfiguration(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_65290_maretronRotationalRate(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_65290_simnetPaddleWheelSpeedConfiguration(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65290."""
...
def decode_pgn_65290_maretronRotationalRate(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65290."""
