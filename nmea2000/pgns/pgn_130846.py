...
def decode_pgn_130846(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130846_simnetParameterSet(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130846_maretronBatteryAmpHourRecord(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130846_furunoMotionSensorStatusExtended(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130846_simnetParameterSet(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130846."""
    ...
    d = d_raw = decode_number(_data_raw_, running_bit_offset, 16, False, 1, 0, 65532)
...
def encode_pgn_130846_simnetParameterSet(nmea2000Message: NMEA2000Message) -> bytes:
    ...
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
    payload_bit_length = max(payload_bit_length, payload_end_offset)
    # value | Offset: 88, Length: , Resolution: , Field Type: DYNAMIC_FIELD_VALUE
    running_bit_offset = 88
    field_offset = running_bit_offset
...
def decode_pgn_130846_maretronBatteryAmpHourRecord(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130846."""
...
def decode_pgn_130846_furunoMotionSensorStatusExtended(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130846."""
