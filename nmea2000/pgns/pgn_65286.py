...
def decode_pgn_65286(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_65286_chetcoDimmer(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_65286_airmarBootStateRequest(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_65286_maretronFluidFlowRate(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_65286_chetcoDimmer(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65286."""
    ...
    dimmer1 = dimmer1_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
    ...
    dimmer2 = dimmer2_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
    ...
    dimmer3 = dimmer3_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
    ...
    dimmer4 = dimmer4_raw = decode_number(_data_raw_, running_bit_offset, 8, False, 1, 0, 252)
...
def encode_pgn_65286_chetcoDimmer(nmea2000Message: NMEA2000Message) -> bytes:
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Dimmer1' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Dimmer1' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Dimmer1' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Dimmer2' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Dimmer2' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Dimmer2' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Dimmer3' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Dimmer3' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Dimmer3' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
    ...
    assert isinstance(field_value, int)
    if field_value < 0:
        raise ValueError("Cant encode this message, 'Dimmer4' cannot be negative")
    if field_bit_length < 0:
        raise ValueError("Cant encode this message, 'Dimmer4' has a negative bit length")
    if field_bit_length > 0 and field_value.bit_length() > field_bit_length:
        raise ValueError("Cant encode this message, 'Dimmer4' exceeds the encoded bit length")
    field_mask = (1 << field_bit_length) - 1 if field_bit_length > 0 else 0
    data_raw |= (field_value & field_mask) << field_offset
    payload_end_offset = field_offset + field_bit_length
    running_bit_offset = payload_end_offset if advance_running_offset else field_offset
...
def decode_pgn_65286_airmarBootStateRequest(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65286."""
...
def decode_pgn_65286_maretronFluidFlowRate(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 65286."""
