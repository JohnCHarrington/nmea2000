...
def decode_pgn_130832(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130832_maretronAlertOperatingMode(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130832_simnetFuelUsedHighResolution(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130832_maretronAlertOperatingMode(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130832."""
...
def decode_pgn_130832_simnetFuelUsedHighResolution(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130832."""
