...
def is_fast_pgn_130312() -> bool:
    ...
    return False
def decode_pgn_130312(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130312."""
    ...
    set_temperature = set_temperature_raw = decode_number(_data_raw_, running_bit_offset, 16, False, 0.01, 0, 655.32)
