...
def decode_pgn_130835(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130835_maretronSmsTextMessage(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130835_simnetSetEngineAndTankConfiguration(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130835_maretronSmsTextMessage(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130835."""
...
def decode_pgn_130835_simnetSetEngineAndTankConfiguration(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130835."""
