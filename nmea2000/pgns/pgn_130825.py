...
def decode_pgn_130825(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130825_maretronDataInstanceChannelCorrelation(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130825_navicoUnknown2(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130825_maretronDataInstanceChannelCorrelation(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130825."""
...
def decode_pgn_130825_navicoUnknown2(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130825."""
