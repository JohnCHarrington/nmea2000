...
def decode_pgn_130822(data_raw: int, data_length_bits: int | None = None) -> NMEA2000Message | None:
    ...
    if (
        ...
        return decode_pgn_130822_navicoUnknown1(data_raw, data_length_bits)
    ...
    if (
        ...
        return decode_pgn_130822_maretronAlertControl(data_raw, data_length_bits)
    
    
    return None
    
def decode_pgn_130822_navicoUnknown1(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130822."""
...
def decode_pgn_130822_maretronAlertControl(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130822."""
