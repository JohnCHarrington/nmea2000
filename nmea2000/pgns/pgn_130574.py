...
def is_fast_pgn_130574() -> bool:
    ...
    return True
def decode_pgn_130574(_data_raw_: int, _data_length_bits_: int) -> NMEA2000Message:
    """Decode PGN 130574."""
    nmea2000Message = NMEA2000Message(PGN=130574, id='supportedZoneData', description='Supported Zone Data', ttl=timedelta(milliseconds=500))
...
def encode_pgn_130574(nmea2000Message: NMEA2000Message) -> bytes:
    ...
    for repeating_entry in repeating_field_set_1_entries:
        ...
        running_bit_offset = payload_end_offset if advance_running_offset else field_offset
        payload_bit_length = max(payload_bit_length, payload_end_offset)
        # name | Offset: 32, Length: , Resolution: , Field Type: STRING_LAU
